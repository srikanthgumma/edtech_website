        ...
        <footer class="bg-blue-900 mt-7 pt-10" id='footer'>
            <div class="mx-auto w-full max-w-screen-xl">
                ...
                <div class="px-4 py-6   md:flex md:items-center md:justify-between">
                    <span class="text-sm text-gray-500 dark:text-gray-300  sm:text-center">© 2024 <a href="#" className='font-bold'>EDTECH</a>. All Rights Reserved.
                    </span>
